...
def supplier_list(request):
    ...
    supplier_data = [{"id": supplier.id, "name": supplier.name} for supplier in suppliers]
...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def sales_summary(self, request):
        ...
        total_value = sales_summary['total_sales'] * sales_summary['total_quantity'] if sales_summary['total_sales'] and sales_summary['total_quantity'] else 0
        sales_summary['total_value'] = total_value
    ...
    def purchase_summary(self, request):
        ...
        total_value = purchase_summary['total_purchases'] * purchase_summary['total_quantity'] if purchase_summary['total_purchases'] and purchase_summary['total_quantity'] else 0
        purchase_summary['total_value'] = total_value
...
# Dans views.py de votre application Django REST Framework
